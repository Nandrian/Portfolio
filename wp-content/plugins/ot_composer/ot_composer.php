<?php
/*
    Plugin Name: Talos Addon Visual Composer
    Plugin URI: http://oceanthemes.net/
    Description: Talos Addon Visual Composer is Child of WPBakery Visual Composer, require install WPBakery Visual Composer plugin.
    Version: 1.1.1
    Author: OceanThemes
