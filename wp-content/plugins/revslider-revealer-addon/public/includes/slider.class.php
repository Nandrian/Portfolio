...
if(class_exists('RevSliderFunctions')) {
	...
	class RsRevealerSliderFront extends RevSliderFunctions {
		...
		public function add_addon_files($html, $export){
			...
			if(!$export->usepcl){
				$export->zip->addFile(RS_REVEALER_PLUGIN_PATH . 'public/assets/js/revolution.addon.' . $this->pluginTitle . $_jsPathMin . '.js', 'js/revolution.addon.' . $this->pluginTitle . $_jsPathMin . '.js');
				$export->zip->addFile(RS_REVEALER_PLUGIN_PATH . 'public/assets/css/revolution.addon.' . $this->pluginTitle . '.css', 'css/revolution.addon.' . $this->pluginTitle . '.css');
				$export->zip->addFile(RS_REVEALER_PLUGIN_PATH . 'public/assets/css/revolution.addon.' . $this->pluginTitle . '.preloaders.css', 'css/revolution.addon.' . $this->pluginTitle . '.preloaders.css');
			}else{
				$export->pclzip->add(RS_REVEALER_PLUGIN_PATH.'public/assets/js/revolution.addon.' . $this->pluginTitle . $_jsPathMin . '.js', PCLZIP_OPT_REMOVE_PATH, RS_REVEALER_PLUGIN_PATH.'public/assets/js/', PCLZIP_OPT_ADD_PATH, 'js/');
				$export->pclzip->add(RS_REVEALER_PLUGIN_PATH.'public/assets/css/revolution.addon.' . $this->pluginTitle . '.css', PCLZIP_OPT_REMOVE_PATH, RS_REVEALER_PLUGIN_PATH.'public/assets/css/', PCLZIP_OPT_ADD_PATH, 'css/');
				$export->pclzip->add(RS_REVEALER_PLUGIN_PATH.'public/assets/css/revolution.addon.' . $this->pluginTitle . '.preloaders.css', PCLZIP_OPT_REMOVE_PATH, RS_REVEALER_PLUGIN_PATH.'public/assets/css/', PCLZIP_OPT_ADD_PATH, 'css/');
			}
			...
			$html = str_replace($this->pluginUrl.'public/assets/css/revolution.addon.' . $this->pluginTitle . '.preloaders.css', 'css/revolution.addon.' . $this->pluginTitle . '.preloaders.css', $html);
		...
		*/
		...
		public function add_html_script_additions($return, $output){
			...
			$return['toload']['revealer'] = '<script'. $addition .' src="'. $this->pluginUrl . 'public/assets/js/revolution.addon.' . $this->pluginTitle . $_jsPathMin . '.js"></script>';
		...
		public function check_if_ajax_loaded($r, $output) {
			...
			$html .= '<link rel="stylesheet" href="'. $this->pluginUrl . 'public/assets/css/revolution.addon.' . $this->pluginTitle . '.preloaders.css">'."\n";
